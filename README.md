...
Remember to set `EXPO_PUBLIC_API_BASE_URL` as a variable in your Expo.dev account 
or as an EAS secret in the `eas.json` `env` block so it is available at build time.
